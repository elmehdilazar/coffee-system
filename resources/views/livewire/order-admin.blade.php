                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu py-0">
                                    ...
                                    <a class="dropdown-item" class="btn btn-block btn-gray-800 mb-3"
                                        ...
                                        data-bs-target="#modal-default{{ $order->id }}"><span
                                ...
                                <div class="modal fade" id="details{{ $order->id }}" tabindex="-1"
                                    role="dialog" aria-labelledby="details{{ $order->id }}" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h2 class="h6 modal-title">Terms of Service</h2>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="my-4">
                                                    ...
                                                    <textarea disabled class="form-control" placeholder="Enter your message..." id="textarea" rows="4">{{ $order->address }}</textarea>
                                                </div>
                                                <div class="mb-3 d-flex">
                                                    <div class="mx-2">
                                                    ...
                                                    <div class="mx-2">
                                                        ...
                                                        <label for="disabledTextInput">zip_code</label>
                                                        <input type="text" id="disabledTextInput"
                                                            class="form-control" placeholder="Disabled input"
                                                ...
                                                <div class="mx-2 d-flex justify-content-center">
                                                    <span class="text-primary mx-2">
                                                     total:<span class="badge bg-info">${{ $order->total }}</span>

                                                    </span> |  <span class="text-primary mx-2">
                                                     date of order:<span class="badge bg-danger">{{ $order->created_at->format('Y-m-d') }}</span>

                                                    </span> |  <span class="text-primary mx-2">
                                                     date of update :<span class="badge bg-success">{{ $order->updated_at->format('Y-m-d') }}</span>
