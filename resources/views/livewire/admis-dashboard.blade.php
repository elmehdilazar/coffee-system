<div>
    ...
    @if ($adding == true || $editing == true)
        <div class="card card-body  w-50 my-2 mx-auto border-0 shadow">
            ...
            @if ($editing == true)
                <form wire:submit.prevent="editingAdmin" id="formM" class="mt-4">
                @else
                    <form wire:submit.prevent="addAdmin" id="formM" class="mt-4">
            @endif
            <!-- Form -->
        ...
        <div class="row align-items-center justify-content-between">
            <div class="col col-md-6 col-lg-3 col-xl-4">
                <div class="input-group me-2 me-lg-3 fmxw-400">
                    ...
                    <input type="text" wire:model="search"  class="form-control" placeholder="Search admins">
                </div>
            </div>
            ...
            <tbody>
                @foreach ($admins as $admin)
                    <tr>
                        ...
                        <td><span class="fw-normal"> {{ $admin->name }}</span></td>
                        <td><span class="fw-normal"> {{ $admin->email }}</span></td>
                        <td>
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu py-0">
                                    ...
                                    <a wire:click="getAdmin({{ $admin->id }})" class="dropdown-item"><span
                                            class="fas fa-edit me-2"></span>Edit</a>
                                    <a class="dropdown-item text-danger rounded-bottom"><span
                                            class="fas fa-trash-alt me-2"
                                            wire:click='RemoveAdmin({{ $admin->id }})'></span>Remove</a>
