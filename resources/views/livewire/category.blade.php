   ...
   @include("layouts.admins.message")
    ...
    @if ($adding == true || $editing == true)
        <div class="card card-body  w-50 my-2 mx-auto border-0 shadow">
            ...
            @if ($editing == true)
                <form wire:submit.prevent="editingCategory" id="formM" class="mt-4">
                @else
                    <form wire:submit.prevent="addCategory" id="formM" class="mt-4">
            @endif
            <!-- Form -->
        ...
        <div class="row align-items-center justify-content-between">
            <div class="col col-md-6 col-lg-3 col-xl-4">
                <div class="input-group me-2 me-lg-3 fmxw-400">
                    ...
                    <input type="search" wire:model.lazy="search"  class="form-control" placeholder="Search categories">
                </div>
            </div>
