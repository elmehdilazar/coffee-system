        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 ftco-animate">
                    <form method="POST" action="{{ route('checkout.proccessing')}}" class="billing-form ftco-bg-dark p-3 p-md-5">
                        @csrf
                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="address"  class="form-control" placeholder="House number and street name" id="" cols="30" rows="4"></textarea>
                                </div>
                            </div>
