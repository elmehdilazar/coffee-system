                                    ...
                                    @if ($carts->count() > 0)
                                        @foreach ($carts as $cart)
                                            <tr class="text-center">
                                                ...
                                                <td class="image-prod">
                                                    <div class="img"
                                                        style="background-image:url({{ asset('storage/images/' . $cart->Product->image) }});">
                                                    </div>
                ...
                @if ($carts->count() > 0)
                    <div class="row justify-content-end">
                        <div class="col col-lg-3 col-md-6 mt-5 cart-wrap ftco-animate">
                            ...
                            <form id="check" method="POST" action="{{ route('cart.precheck') }}">
                                @csrf
                                <input type="hidden" name="price" value="{{$total}}">
                            </form>
                            <p class="text-center"><button type="submit" form="check" name="submit"
                                    class="btn btn-primary py-3 px-4">Proceed to Checkout</button>
